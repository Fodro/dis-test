...
type Discipline interface {
	...
	Create(title string, creditUnits float32, academicHours uint32) (*api.Discipline, error)
	Delete(id int) error
	Update(id int, title string, creditUnits float32, academicHours uint32) (*api.Discipline, error)
